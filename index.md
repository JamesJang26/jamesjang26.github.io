...
😁 Welcome to my blog! My name is **Dongsuk Jang**, and I am a Master's candidate at Seoul National University in the [MEDINFO Lab](https://medinfolab.snu.ac.kr/), where I am fortunate to be advised by Professor [Jinwook Choi](https://scholar.google.com/citations?user=At673E8AAAAJ&hl=en). I was also a visiting student at Yale University in the [YaleNLP](https://nlp.cs.yale.edu/), advised by Professor [Arman Cohan](https://scholar.google.com/citations?user=baI7IY0AAAAJ&hl=en). My primary research interests lie in AI for Science and Medicine, with a focus on RAG, Reasoning, Agents, and Multimodal AI. In my spare time, I enjoy working on personal projects that pique my curiosity such as developing a vision-based Tennis AI coaching system  and a book translation agent.

<!-- I am currently pursuing a master’s degree at [Seoul National University](https://en.wikipedia.org/wiki/Seoul_National_University), primarily focusing on **NLP** using medical data. Through this blog, I share my learnings, projects, and some thoughts. -->
