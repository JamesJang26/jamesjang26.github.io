...
{% include figure.liquid path="assets/img/tennis_cvat1.png" class="img-fluid rounded z-depth-1" max-width="800px" caption="CVAT annotation tool - Task list" %}

{% include figure.liquid path="assets/img/tennis_cvat2.png" class="img-fluid rounded z-depth-1" max-width="800px" caption="CVAT annotation tool - Labeling interface" %}
